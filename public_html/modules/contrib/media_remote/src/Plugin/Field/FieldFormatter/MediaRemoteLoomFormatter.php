...
/**
 * Plugin implementation of the 'media_remote_loom' formatter.
 *
 * @FieldFormatter(
 *   id = "media_remote_loom",
 *   label = @Translation("Remote Media - Loom"),
 *   field_types = {
 *     "string"
 *   }
 * )
 */
class MediaRemoteLoomFormatter extends MediaRemoteFormatterBase {

  /**
   * {@inheritdoc}
   */
  public static function getUrlRegexPattern() {
    return '/^https:\/\/www\.loom\.com\/share\/(.*)/';
  }
  ...
  public static function getValidUrlExampleStrings(): array {
    return [
      'https://www.loom.com/share/91ad056cbe274b3f82add5e48beba123',
    ];
  }
